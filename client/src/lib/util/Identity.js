 ...
 * 
 * NOTE: At the time of this writing, this was copied from `\util`.
 */
export class Identity {
	...
	constructor ({ id, tokens = [] } = {}) {
		...
		/**
		 * Put anything here that you would like to be associated
		 * with this identity, (e.g. descriptive, searchable, etc.)
		 */
